...
def area(radius) : # 전달받은 반지름을 매개 변수에 저장
    result = 3.13 * radius**2 # 원의 넓이 계산
    return result # result 값을 호출한 곳으로 돌려줌

result = area(3)
print("반지름이 3인 원의 넓이 :",result)
...
print(f"반지름이 {r}인 원의 넓이 : {result}") # result에 저장된 결과 출력
print(f"반지름이 {r}인 원의 넓이 : {area(r)}") # 반지름을 가지고 함수 호출하고, 전달받아 바로 출력